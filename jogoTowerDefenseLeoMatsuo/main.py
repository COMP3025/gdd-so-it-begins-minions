...
def display_data():
  pg.draw.rect(screen, "grey", (c.SCREEN_WIDTH, 0, c.SIDE_PANEL, c.SCREEN_HEIGHT))
...
begin_button = Button(c.SCREEN_WIDTH + 60, c.SCREEN_HEIGHT - 90, begin_image, True)
...
while run:
  ...
  if game_over == False:
    ...
    if game_outcome == -1:
      ...
      draw_text("Ganhoooooooou!", large_font, "grey0", 315, 230)
